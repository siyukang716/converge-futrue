package com.cloud.aspectj;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.support.spring.PropertyPreFilters;
import com.cloud.annotation.Log;
import com.cloud.enums.BusinessStatus;
import com.cloud.json.JSON;
import com.cloud.log.entity.SysOperLogEntity;
import com.cloud.shiro.ShiroUtils;
import com.cloud.sys.UserEntity;
import com.cloud.util.ServletUtils;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.cloud.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 获取当前的用户
            UserEntity currentUser = ShiroUtils.getLoginUser();
