...
public class Result<T> {
    ...
    public static Result success(String data) {
		return new Result(IStatusMessage.SystemStatus.SUCCESS.getCode(),"操作成功(*＾-＾*)",data);
    }
	public static Result success() {
		return new Result(IStatusMessage.SystemStatus.SUCCESS.getCode(),"操作成功(*＾-＾*)");
	}
