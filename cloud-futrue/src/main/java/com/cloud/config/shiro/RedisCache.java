...
import com.cloud.exceptions.PrincipalIdNullException;
import com.cloud.exceptions.PrincipalInstanceException;
...
public class RedisCache<K, V> implements Cache<K, V> {
    ...
    private String getStringRedisKey(K key) {
        ...
        } else if(key instanceof UserEntity){
            redisKey = ((UserEntity)key).getMobile();
        } else {
