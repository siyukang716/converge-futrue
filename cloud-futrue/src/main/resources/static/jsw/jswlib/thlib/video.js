/**
 * @license
 * Video.js 5.19.0 <http://bvVideojs.com/>
 * Copyright Brightcove, Inc. <https://www.brightcove.com/>
 * Available under Apache License Version 2.0
 * <https://github.com/bvVideojs/video.js/blob/master/LICENSE>
 *
...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.bvVideojs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
'use strict';
...
var Component = function () {
  ...
  Component.prototype.addChild = function addChild(child) {
    ...
    if (typeof child === 'string') {
      ...
      // data stored directly on the bvVideojs object may be
  ...
  Component.prototype.initChildren = function initChildren() {
    ...
    if (children) {
      ...
      var handleAdd = function handleAdd(child) {
        ...
        // e.g. bvVideojs(id, { controlBar: false });
        // instead of bvVideojs(id, { children: { controlBar: false });
      ...
      .concat(Object.keys(this.options_).filter(function (child) {
        ...
        // See https://github.com/bvVideojs/video.js/issues/2772
  ...
  /**
   * Register a `Component` with `bvVideojs` given the name and the component.
   *
   * > NOTE: {@link Tech}s should not be registered as a `Component`. {@link Tech}s
   *         should be registered using {@link Tech.registerTech} or
   *         {@link bvVideojs:bvVideojs.registerTech}.
   *
   * > NOTE: This function can also be seen on bvVideojs as
   *         {@link bvVideojs:bvVideojs.registerComponent}.
   *
   * @param {string} name
   ...
   *
   * @deprecated In `bvVideojs` 6 this will not return `Component`s that were not
   *             registered using {@link Component.registerComponent}. Currently we
   *             check the global `bvVideojs` object for a `Component` name and
  ...
  Component.getComponent = function getComponent(name) {
    ...
    if (_window2['default'] && _window2['default'].bvVideojs && _window2['default'].bvVideojs[name]) {
      _log2['default'].warn('The ' + name + ' component was added to the bvVideojs object when it should be registered using bvVideojs.registerComponent(name, component)');

      return _window2['default'].bvVideojs[name];
    }
  };
  ...
  Component.extend = function extend(props) {
    ...
    _log2['default'].warn('Component.extend({}) has been deprecated, ' + ' use bvVideojs.extend(Component, {}) instead');
 ...
 * 1. By calling `bvVideojs('example_video_1');`
 * 2. By using it directly via  `bvVideojs.players.example_video_1;`
 *
 * @extends Component
 */
...
var Player = function (_Component) {
  ...
  function Player(tag, options, ready) {
    ...
    if (!_this.options_ || !_this.options_.techOrder || !_this.options_.techOrder.length) {
      throw new Error('No techOrder specified. Did you overwrite ' + 'bvVideojs.options instead of just changing the ' + 'properties you want to override?');
    }
  ...
  Player.prototype.tech = function tech(safety) {
    ...
    var errorText = '\n      Please make sure that you are not using this inside of a plugin.\n      To disable this alert and error, please pass in an object with\n      `IWillNotUseThisInPlugins` to the `tech` method. See\n      https://github.com/bvVideojs/video.js/issues/2617 for more info.\n    ';
   ...
   * Merge every time, because a newly added plugin might call bvVideojs.addLanguage() at any time
...
/**
 * The method for registering a video.js plugin. {@link bvVideojs:bvVideojs.registerPlugin].
 *
 * @param {string} name
 ...
 *
 * @param {bvVideojs} [vjs]
 *        The bvVideojs library function
 */
...
var Flash = function (_Tech) {
  ...
  function Flash(options, ready) {
    ...
    _window2['default'].bvVideojs = _window2['default'].bvVideojs || {};
    _window2['default'].bvVideojs.Flash = _window2['default'].bvVideojs.Flash || {};
    _window2['default'].bvVideojs.Flash.onReady = Flash.onReady;
    _window2['default'].bvVideojs.Flash.onEvent = Flash.onEvent;
    _window2['default'].bvVideojs.Flash.onError = Flash.onError;
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    var flashVars = (0, _obj.assign)({
      ...
      readyFunction: 'bvVideojs.Flash.onReady',
      eventProxyFunction: 'bvVideojs.Flash.onEvent',
      errorEventProxyFunction: 'bvVideojs.Flash.onError',
...
var Html5 = function (_Tech) {
  ...
  /**
   * This will be triggered if the loadstart event has already fired, before bvVideojs was
   * ready. Two known examples of when this can happen are:
   * 1. If we're loading the playback object after it has started loading
   * 2. The media is already playing the (often with autoplay on) then
   *
   * This function will fire another loadstart so that bvVideojs can catchup.
   *
...
Html5.canControlPlaybackRate = function () {
  ...
  // https://github.com/bvVideojs/video.js/issues/3180
...
Html5.nativeSourceHandler.canPlayType = function (type) {
  ...
  // https://github.com/bvVideojs/video.js/issues/519
  try {
...
var Tech = function (_Component) {
  ...
  /**
   * Registers a `Tech` into a shared list for bvVideojs.
   *
   * @param {string} name
  ...
  Tech.getTech = function getTech(name) {
    ...
    if (_window2['default'] && _window2['default'].bvVideojs && _window2['default'].bvVideojs[name]) {
      _log2['default'].warn('The ' + name + ' tech was added to the bvVideojs object when it should be registered using bvVideojs.registerTech(name, tech)');
      return _window2['default'].bvVideojs[name];
    }
  };
...
function fixEvent(event) {
  ...
  if (!event || !event.isPropagationStopped) {
    ...
    if (event.button !== null && event.button !== undefined) {
      ...
      // The following is disabled because it does not pass bvVideojs-standard
      // and... yikes.
      /* eslint-disable */
 ...
 * The `bvVideojs` function can be used to initialize or retrieve a player.
  *
 ...
 * @mixes bvVideojs
 */
function bvVideojs(id, options, ready) {
  var tag = void 0;
  ...
  if (typeof id === 'string') {
    ...
    if (bvVideojs.getPlayers()[id]) {
      ...
      if (ready) {
        bvVideojs.getPlayers()[id].ready(ready);
      }

      return bvVideojs.getPlayers()[id];
    }
  ...
  if (!tag || !tag.nodeName) {
    throw new TypeError('The element or ID supplied is not valid. (bvVideojs)');
  }
  ...
  bvVideojs.hooks('beforesetup').forEach(function (hookFunction) {
  ...
  bvVideojs.hooks('setup').forEach(function (hookFunction) {
 ...
 */
bvVideojs.hooks = function (type, fn) {
  bvVideojs.hooks_[type] = bvVideojs.hooks_[type] || [];
  if (fn) {
    bvVideojs.hooks_[type] = bvVideojs.hooks_[type].concat(fn);
  }
  return bvVideojs.hooks_[type];
};

/**
 * Add a function hook to a specific bvVideojs lifecycle.
 *
 * @param {string} type
 ...
 */
bvVideojs.hook = function (type, fn) {
  bvVideojs.hooks(type, fn);
};

/**
 * Remove a hook from a specific bvVideojs lifecycle.
 *
 * @param {string} type
 ...
 */
bvVideojs.removeHook = function (type, fn) {
  var index = bvVideojs.hooks(type).indexOf(fn);

  if (index <= -1) {
    return false;
  }

  bvVideojs.hooks_[type] = bvVideojs.hooks_[type].slice();
  bvVideojs.hooks_[type].splice(index, 1);
...
setup.autoSetupTimeout(1, bvVideojs);
 ...
 * @type {Object}
 */
bvVideojs.options = _player2['default'].prototype.options_;
 ...
 */
bvVideojs.players = _player2['default'].players;

/**
 * Get a component class object by name
 *
 * @borrows Component.getComponent as bvVideojs.getComponent
 */
bvVideojs.getComponent = _component2['default'].getComponent;
 ...
 */
bvVideojs.registerComponent = function (name, comp) {
  if (_tech2['default'].isTech(comp)) {
    _log2['default'].warn('The ' + name + ' tech was registered as a component. It should instead be registered using bvVideojs.registerTech(name, tech)');
  }
 ...
 *
 * @borrows Tech.getTech as bvVideojs.getTech
 */
bvVideojs.getTech = _tech2['default'].getTech;

/**
 * Register a Tech so it can referred to by name.
 * This is used in the tech order for the player.
 *
 * @borrows Tech.registerTech as bvVideojs.registerTech
 */
bvVideojs.registerTech = _tech2['default'].registerTech;
 ...
 * @private
 */
bvVideojs.browser = browser;

/**
 * Whether or not the browser supports touch events. Included for backward
 * compatibility with 4.x, but deprecated. Use `bvVideojs.browser.TOUCH_ENABLED`
 * instead going forward.
 *
 * @deprecated since version 5.0
 * @type {boolean}
 */
bvVideojs.TOUCH_ENABLED = browser.TOUCH_ENABLED;

/**
 * Subclass an existing class
 * Mimics ES6 subclassing with the `extend` keyword
 *
 * @borrows extend:extendFn as bvVideojs.extend
 */
bvVideojs.extend = _extend2['default'];
 ...
 *
 * @borrows merge-options:mergeOptions as bvVideojs.mergeOptions
 */
bvVideojs.mergeOptions = _mergeOptions3['default'];
 ...
 *
 * @borrows fn:bind as bvVideojs.bind
 */
bvVideojs.bind = Fn.bind;
 ...
 * called.
 *
 * @borrows plugin:plugin as bvVideojs.plugin
 */
bvVideojs.plugin = _plugins2['default'];

/**
 * Adding languages so that they're available to all players.
 * Example: `bvVideojs.addLanguage('es', { 'Hello': 'Hola' });`
 *
 * @param {string} code
 ...
 */
bvVideojs.addLanguage = function (code, data) {
  var _mergeOptions;

  code = ('' + code).toLowerCase();

  bvVideojs.options.languages = (0, _mergeOptions3['default'])(bvVideojs.options.languages, (_mergeOptions = {}, _mergeOptions[code] = data, _mergeOptions));

  return bvVideojs.options.languages[code];
};

/**
 * Log messages
 *
 * @borrows log:log as bvVideojs.log
 */
bvVideojs.log = _log2['default'];

/**
 * Creates an emulated TimeRange object.
 *
 * @borrows time-ranges:createTimeRanges as bvVideojs.createTimeRange
 */
/**
 * @borrows time-ranges:createTimeRanges as bvVideojs.createTimeRanges
 */
bvVideojs.createTimeRange = bvVideojs.createTimeRanges = _timeRanges.createTimeRanges;
 ...
 *
 * @borrows format-time:formatTime as bvVideojs.formatTime
 */
bvVideojs.formatTime = _formatTime2['default'];

/**
 * Resolve and parse the elements of a URL
 *
 * @borrows url:parseUrl as bvVideojs.parseUrl
 */
bvVideojs.parseUrl = Url.parseUrl;

/**
 * Returns whether the url passed is a cross domain request or not.
 *
 * @borrows url:isCrossOrigin as bvVideojs.isCrossOrigin
 */
bvVideojs.isCrossOrigin = Url.isCrossOrigin;

/**
 * Event target class.
 *
 * @borrows EventTarget as bvVideojs.EventTarget
 */
bvVideojs.EventTarget = _eventTarget2['default'];
 ...
 * along with a unique id (guid) to the element.
 *
 * @borrows events:on as bvVideojs.on
 */
bvVideojs.on = Events.on;

/**
 * Trigger a listener only once for an event
 *
 * @borrows events:one as bvVideojs.one
 */
bvVideojs.one = Events.one;

/**
 * Removes event listeners from an element
 *
 * @borrows events:off as bvVideojs.off
 */
bvVideojs.off = Events.off;

/**
 * Trigger an event for an element
 *
 * @borrows events:trigger as bvVideojs.trigger
 */
bvVideojs.trigger = Events.trigger;
 ...
 */
bvVideojs.xhr = _xhr2['default'];

/**
 * TextTrack class
 *
 * @borrows TextTrack as bvVideojs.TextTrack
 */
bvVideojs.TextTrack = _textTrack2['default'];

/**
 * export the AudioTrack class so that source handlers can create
 * AudioTracks and then add them to the players AudioTrackList
 *
 * @borrows AudioTrack as bvVideojs.AudioTrack
 */
bvVideojs.AudioTrack = _audioTrack2['default'];

/**
 * export the VideoTrack class so that source handlers can create
 * VideoTracks and then add them to the players VideoTrackList
 *
 * @borrows VideoTrack as bvVideojs.VideoTrack
 */
bvVideojs.VideoTrack = _videoTrack2['default'];

/**
 * Determines, via duck typing, whether or not a value is a DOM element.
 *
 * @borrows dom:isEl as bvVideojs.isEl
 */
bvVideojs.isEl = Dom.isEl;

/**
 * Determines, via duck typing, whether or not a value is a text node.
 *
 * @borrows dom:isTextNode as bvVideojs.isTextNode
 */
bvVideojs.isTextNode = Dom.isTextNode;

/**
 * Creates an element and applies properties.
 *
 * @borrows dom:createEl as bvVideojs.createEl
 */
bvVideojs.createEl = Dom.createEl;

/**
 * Check if an element has a CSS class
 *
 * @borrows dom:hasElClass as bvVideojs.hasClass
 */
bvVideojs.hasClass = Dom.hasElClass;

/**
 * Add a CSS class name to an element
 *
 * @borrows dom:addElClass as bvVideojs.addClass
 */
bvVideojs.addClass = Dom.addElClass;

/**
 * Remove a CSS class name from an element
 *
 * @borrows dom:removeElClass as bvVideojs.removeClass
 */
bvVideojs.removeClass = Dom.removeElClass;

/**
 * Adds or removes a CSS class name on an element depending on an optional
 * condition or the presence/absence of the class name.
 *
 * @borrows dom:toggleElClass as bvVideojs.toggleClass
 */
bvVideojs.toggleClass = Dom.toggleElClass;

/**
 * Apply attributes to an HTML element.
 *
 * @borrows dom:setElAttributes as bvVideojs.setAttribute
 */
bvVideojs.setAttributes = Dom.setElAttributes;
 ...
 * This will return true or false for boolean attributes.
 *
 * @borrows dom:getElAttributes as bvVideojs.getAttributes
 */
bvVideojs.getAttributes = Dom.getElAttributes;

/**
 * Empties the contents of an element.
 *
 * @borrows dom:emptyEl as bvVideojs.emptyEl
 */
bvVideojs.emptyEl = Dom.emptyEl;
 ...
 *   node, or array.
 *
 * @borrows dom:appendContents as bvVideojs.appendContet
 */
bvVideojs.appendContent = Dom.appendContent;
 ...
 *   node, or array.
 *
 * @borrows dom:insertContent as bvVideojs.insertContent
 */
bvVideojs.insertContent = Dom.insertContent;
 ...
 *
 * @borrows computed-style:computedStyle as bvVideojs.computedStyle
 */
bvVideojs.computedStyle = _computedStyle2['default'];
...
if (typeof define === 'function' && define.amd) {
  define('bvVideojs', [], function () {
    return bvVideojs;
  });

  // checking that module is an object too because of umdjs/umd#35
} else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') {
  module.exports = bvVideojs;
}

exports['default'] = bvVideojs;
